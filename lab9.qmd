...
# function to create random palette from danielle workshop
...
# danielle function to create art
...
draw_mosaic <- function(dat, palette) {
  background <- sample(palette[1:5], 1)
  dat |>
...
my_pal <- c("#4A5d23", "#708238", "#568203","#8A9A5B", "#6B8E23", "#A0522D", "#8B4513", "#7e481c")
...
mosaica <- function(ncol = 60, 
  ...
  subdivision(ncol, nrow, nsplits, seed) |>
    ...
    filter(!is.na(fill)) |>
    draw_mosaic(palette = my_pal)
}



mosaica(ncol = 100, nrow = 100, nsplits = 2000)
```
